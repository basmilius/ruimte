...
const TEAM_DETAIL: readonly string[] = [
    ...
    "edges\tWithout --task, ruimte-context link --to <the role's id> draws the line back, which is how you read what a role has done; its id is the first field of that role's row",
