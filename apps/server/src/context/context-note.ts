...
const COMPUTER_NOTE =
    'With `ruimte-context computer` you read and operate the apps of this Mac, each only once the person lets you into it; use it only when they ask you to work in an app. The person can pause you, take over or stop you at any moment: then wait for them, or ask them, instead of calling again in a loop.';
