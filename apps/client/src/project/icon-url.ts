 ...
 * so the URL carries the endpoint's credential the same way the socket does. The version pins one set
 ...
 * machine's icon would paint both sets of icons through one daemon's credential.
 */
