...
const STYLE: Record<TransportStatus, { color: string; label: string }> = {
    ...
    connecting: { color: 'bg-status-needs-you', label: 'Connecting to the server' },
...
export function ConnectionDot() {
    ...
    return (
        <span className="grid h-8 w-5 shrink-0 place-items-center" title={label} role="status" aria-label={label}>
