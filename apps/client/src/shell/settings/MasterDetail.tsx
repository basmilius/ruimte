 ...
 * machines, shortcut categories). Each side scrolls on its own; the detail keeps a readable width
 * however wide the dialog is. The section id must be `split` in `sections.ts`, so the dialog hands the
