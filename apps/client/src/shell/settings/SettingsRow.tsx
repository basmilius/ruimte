        ...
        <div className={clsx('flex flex-col gap-3 px-4', description || children ? 'py-3' : 'py-2')}>
            <div className="flex items-center gap-4">
                <div className="min-w-0 grow">
                    <div className={clsx('text-[13px]', muted ? 'text-text-muted' : 'text-text')}>{label}</div>
                    {description && <div className="mt-0.5 text-[12px] leading-snug text-text-muted">{description}</div>}
                </div>
