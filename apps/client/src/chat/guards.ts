// What a CLI still accepts without the turn becoming slower than the answer is worth. T3 Code
// stops at the same number, and a Claude user frame this large is legal but sluggish.
