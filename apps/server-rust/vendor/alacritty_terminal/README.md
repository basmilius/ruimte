...
This is `alacritty_terminal` 0.26.0 from the upstream Alacritty repository. Ruimte keeps the upstream Apache-2.0 license and Cargo metadata in this directory. See [README-RUIMTE.md](README-RUIMTE.md) for the source revision and complete local patch inventory.
