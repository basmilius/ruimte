...
public enum WireRequest: String, CaseIterable, Sendable {
    ...
    case `flowOpen` = "flow.open"
    case `flowSave` = "flow.save"
    case `flowClose` = "flow.close"
    case `flowCopy` = "flow.copy"
    case `flowState` = "flow.state"
    case `flowEnable` = "flow.enable"
    case `flowStart` = "flow.start"
    case `flowTest` = "flow.test"
    case `flowArm` = "flow.arm"
...
public enum WireEvent: String, CaseIterable, Sendable {
    ...
    case `flowChanged` = "flow.changed"
    case `flowSwitched` = "flow.switched"
    case `flowRun` = "flow.run"
    case `flowStep` = "flow.step"
    case `flowNotice` = "flow.notice"
