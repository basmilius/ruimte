...
final class SignInOperation {
    ...
    func perform(_ action: @escaping @MainActor () async throws -> SessionView) async throws -> SessionView {
        cancel()
...
public final class WebAuthentication: NSObject, ASWebAuthenticationPresentationContextProviding {
    ...
    public func signIn(provider: ProviderId, client: AddressBookClient, vault: SessionVault, label: String) async throws -> SessionView {
        do {
    ...
    private func authenticate(_ url: URL) async throws -> URL {
        ...
        return try await withTaskCancellationHandler {
            ...
            return try await withCheckedThrowingContinuation { continuation in
                ...
                let session = ASWebAuthenticationSession(url: url, callback: .customScheme("ruimte")) { [weak self] callback, error in
                    Task { @MainActor in
