...
import { CHAT_ATTACHMENTS_MAX_COUNT } from '@ruimte/agent-contracts';
import { EMPTY_DRAFT, joinDraftText, offerDraft, takeBackIntoDraft, takeDraftOffers } from './drafts';
