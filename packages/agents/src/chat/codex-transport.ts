...
/* How the host names itself in the `initialize` every app-server is opened with. */
...
export const DEFAULT_CODEX_CLIENT: CodexClientInfo = { name: 'agents', title: 'Agents', version: '0.1.0' };
