import { CodexBackend, type CodexBackendOptions } from '../chat/codex-backend.ts';
...
export const createCodexProvider = (options: CodexBackendOptions = {}): ChatProvider => ({
    kind: 'codex',
    name: 'Codex',
    ...
    home: { env: 'CODEX_HOME', fallback: '.codex', loginEnv: ['OPENAI_API_KEY', 'CODEX_API_KEY', 'CODEX_ACCESS_TOKEN'], loginCommand: 'codex login' },
    detect: detectCli,
