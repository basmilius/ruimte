> Statuscorrectie, 16 september 2026: de eerste drie punten zijn geïmplementeerd. Beide APNs-sleutelparen zijn na toestemming op productie geactiveerd en migraties 0006 en 0008 zijn toegepast. Pulsar en de webclient zijn gedeployd. Desktoprelease v0.0.17 is gepubliceerd op commit `6e02758d` en de npm-publicatie van de losse daemon is geslaagd; de lokale daemon draait nog 0.0.16 en is niet herstart. iOS-distributie blijft uitgesteld. Lees de actuele secties van [het rapport](2026-09-15-ios-app.html) en het laatste [iteratieverslag](2026-09-15-ios-composer-review.md). De oorspronkelijke opdracht hieronder blijft als historie bewaard.
