> Statuscorrectie, 16 september 2026: de eerste drie punten hieronder zijn opgepakt in `86dbcfc5`. De signed iPhone-build is geïnstalleerd en gestart. De daemon is niet herstart; beide APNs-sleutels staan inmiddels lokaal in `~/.private/ruimte/apns`, en zijn als secrets naar een ongeactiveerde Cloudflare Worker-versie geüpload. Migraties 0006 en 0008 zijn toegepast; activering op productie wacht op expliciete toestemming na een afwijzing door de automatische goedkeuringscontrole. Distributie is uitgesteld op verzoek. Lees de actuele secties van [het rapport](2026-09-15-ios-app.html) en het laatste [iteratieverslag](2026-09-15-ios-composer-review.md). De oorspronkelijke opdracht hieronder blijft als historie bewaard en is geen opdracht om de implementatie opnieuw te doen.
